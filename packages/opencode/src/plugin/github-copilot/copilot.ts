              ...
              try {
                ...
                if (body?.messages && url.includes("completions")) {
                  ...
                  return {
                    ...
                    isAgent: body.messages.length > 2 || detectAgent(body.messages) || imgMsg(last),
                ...
                if (body?.input) {
                  ...
                  return {
                    ...
                    isAgent: body.messages.length > 2 || detectAgent(body.input) || imgMsg(last),
                    // isAgent: last?.role !== "user" || imgMsg(last),
                  }
                }
                ...
                if (body?.messages) {
                  ...
                  return {
                    ...
                    isAgent: body.messages.length > 2 || !(last?.role === "user" && hasNonToolCalls) || imgMsg(last),
